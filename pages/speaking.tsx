...
const biography = [
  "I'm a competitive coder, developer and an aspiring engineer.",
  "I'm a competitive coder, developer and an aspiring engineer.",
  'Mohd Sameer is an Engineer.',
  'Mohd Sameer is a Backend Engineer who lives in India..'
];
...
export default function Talks({ talks }) {
  ...
  return (
    <Container title="Talks - Mohd Sameer">
      <h1>
          ...
          <ul>
            ...
            <li>
              ...
              <a href={siteMetadata.siteUrl} target="_blank" rel="noreferrer">
                https://myselfmohdsameer.vercel.app
              </a>
            </li>
            <li>
              LinkedIn:{' '}
