...
export const getWorkTimelineData = async (databaseId) => {
  ...
  response.results.forEach((item: any) => {
    results.push({
      ...
      company: 'Rocket.Chat',
      description: 'Developing a connector app for integrating world’s largest open source chatting platform (Rocket.Chat) with Miro.',
      duration: 'May 2023 - Present',
      comapny_url: 'https://rocket.chat'
    });
  });
